...
/*
 * str_cmb - Concatenate two strings with a '/' character in between.
 * @buffer: Pointer to the buffer where the concatenated string will be stored.
...
/*	struct stat st;*/
	...
	while (1)
	{
		...
		args[4] = NULL;
		i = 1;
		write(STDOUT_FILENO, "#farshell$ ", 9);
